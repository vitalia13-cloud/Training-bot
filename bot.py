...
async def cmd_help(message: Message):
    await message.answer(
        "⚙️ *Як підключити TradingView Webhook:*\n\n"
        ...
        "}\n"
        "```\n"
        "4️⃣ Збережи — сигнали надходитимуть автоматично ✅",
        parse_mode="Markdown"
    )

@dp.message(F.photo)
async def handle_photo(message: Message):
    await message.answer("🔍 Аналізую графік... зачекай кілька секунд")
    try:
